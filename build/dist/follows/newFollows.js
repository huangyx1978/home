...
import { ListView } from 'tonva-react-form';
            ...
            nav.replace(React.createElement(Page, { header: '\u63A5\u53D7\u9080\u8BF7', back: "close" },
                React.createElement("div", { className: "card" },
                    React.createElement("div", { className: "card-body" },
                        React.createElement("div", { className: "card-title" }, "\u5C0F\u53F7\u6210\u5458"),
                        React.createElement("div", { className: "card-text" },
                            "\u4F60\u5DF2\u6210\u4E3A",
                            "-",
                            "\u7684\u6210\u5458\u3002"),
                        React.createElement("button", { className: "btn btn-primary", onClick: () => nav.back() }, "\u5B8C\u6210")))));
        });
    }
    refuse(um) {
        return __awaiter(this, void 0, void 0, function* () {
            yield store.follow.refuseInvite(um);
        });
    }
    converter(um) {
        ...
        return {
            ...
            right: React.createElement("div", null,
                React.createElement("button", { className: 'mr-2 btn btn-success btn-sm', onClick: accept }, "\u63A5\u53D7"),
                React.createElement("button", { className: 'btn btn-sm btn-outline-danger', onClick: refuse }, "\u62D2\u7EDD")),
        };
    }
    render() {
        ...
        return React.createElement(Page, { header: "\u9080\u8BF7" },
            "\u65B0\u6536\u5F55",
            React.createElement("button", { className: "btn btn-primary", onClick: this.test1 }, "WS1"),
            React.createElement("button", { className: "btn btn-primary", onClick: this.test0 }, "WS0"),
