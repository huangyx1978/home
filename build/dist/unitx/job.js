...
export class JobPage extends VPage {
    constructor() {
        ...
        this.edit = () => __awaiter(this, void 0, void 0, function* () {
            this.msg.subject += '.1';
        });
        this.flowRender = (flow, index) => {
    ...
    buildFlow(rows) {
        ...
        rows.push({
            type: 'component',
            full: true,
            component: React.createElement(List, { className: "w-100", header: React.createElement(Muted, { className: "px-3 py-1" }, "\u6D41\u7A0B"), items: flows, item: { render: this.flowRender } })
        });
        rows.push('');
        if (flow === undefined)
            return;
        rows.push({
            ...
            component: React.createElement("div", { className: "w-100" },
                React.createElement(LMR, { left: React.createElement("button", { className: "btn btn-success", onClick: this.finish }, "\u5B8C\u6210"), right: React.createElement("button", { className: "btn btn-info", onClick: this.decline }, "\u505A\u4E0D\u4E86") }))
