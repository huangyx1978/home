...
export class JobPage extends React.Component {
    ...
    componentDidMount() {
        return __awaiter(this, void 0, void 0, function* () {
            let ret = yield store.unit.unitx.getMessage(this.props.msg.id);
            this.setState(ret);
        });
    }
    finish() {
        return __awaiter(this, void 0, void 0, function* () {
            let { msg } = this.props;
            yield store.unit.unitx.actMessage(msg, 'done', '#', [{ user: 0 }]);
    ...
    decline() {
        return __awaiter(this, void 0, void 0, function* () {
            let { msg } = this.props;
            yield store.unit.unitx.actMessage(msg, 'decline', '#-', [{ user: 0 }]);
    ...
    render() {
        ...
        return React.createElement(Page, { header: "\u5904\u7406\u4EFB\u52A1" },
            React.createElement(PropGrid, { className: "px-3 py-2", rows: rows, values: msg }));
    }
}
/*
<div>
