...
class Approved extends React.Component {
    onClick() {
        if (this.props.pointer === false)
            return;
        nav.push(React.createElement(UnitCreatePage, Object.assign({ title: this.title, unitType: this.unitType }, this.props)));
    }
    render() {
...
class UnitCreatePage extends React.Component {
    ...
    onSubmit(values) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let unitId = yield store.unitCreate(values.name, this.props.id);
            let error;
            switch (unitId) {
                default:
