...
let Home = class Home extends React.Component {
    ...
    stickyUnit(date, unit, unread) {
        ...
        if (subject !== undefined)
            vice = React.createElement("div", { className: "small text-success" }, subject);
        else
            vice = React.createElement("div", { className: "small text-muted" }, discription);
