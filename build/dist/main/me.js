...
class Me extends React.Component {
    ...
    about() {
        ...
        nav.push(React.createElement(Page, { header: "\u5173\u4E8E\u540C\u82B1", right: right },
            React.createElement(About, null)));
    }
    showLogs() {
        nav.push(React.createElement(Page, { header: "Logs" }, nav.logs.map((v, i) => {
            ...
            nav.push(React.createElement(Page, { header: "\u5B8C\u6210", back: "close" },
                React.createElement("div", { className: "card" },
                    React.createElement("div", { className: "card-body" },
                        React.createElement("div", { className: "card-title" }, "\u7533\u8BF7\u5DF2\u53D1\u9001"),
                        React.createElement("div", { className: "card-text" }, "\u8BF7\u7A0D\u7B49\uFF0C\u6211\u4EEC\u4F1A\u5C3D\u5FEB\u5904\u7406\u3002"),
...
class ChangePasswordPage extends React.Component {
    constructor() {
        ...
        this.onSubmit = (values) => __awaiter(this, void 0, void 0, function* () {
            ...
            let ret = yield mainApi.resetPassword({ orgPassword: orgPassword, newPassword: newPassword });
            if (ret === false) {
    ...
    render() {
        ...
        return React.createElement(Page, { header: "\u4FEE\u6539\u5BC6\u7801" },
            React.createElement(TonvaForm, { ref: tf => this.form = tf, className: "m-3", formRows: rows, onSubmit: this.onSubmit }));
    }
}
export default Me;
